...
12. [2025 ICCV] **HoliTracer: Holistic Vectorization of Geographic Objects from Large-Size Remote Sensing Imagery.** [[paper]](https://openaccess.thecvf.com/content/ICCV2025/papers/Wang_HoliTracer_Holistic_Vectorization_of_Geographic_Objects_from_Large-Size_Remote_Sensing_ICCV_2025_paper.pdf) [[code]](https://github.com/vvangfaye/HoliTracer)[[Notes](#HiliT)]
13. **RS-vHeat: Heat Conduction Guided Efficient Remote Sensing Foundation Model**[[paper]](https://openaccess.thecvf.com/content/ICCV2025/papers/Hu_RS-vHeat_Heat_Conduction_Guided_Efficient_Remote_Sensing_Foundation_Model_ICCV_2025_paper.pdf)该文章无开源代码，但是相同技术的代码链接为[[code]](https://github.com/MzeroMiko/vHeat)
14. [2025 arXiv] **SAR-KnowLIP: Towards Multimodal Foundation Models for Remote Sensing.** [[paper]](https://arxiv.org/pdf/2509.23927) [[code]](https://github.com/yangyifremad/SARKnowLIP)
15. [2025 AAAI] **ZoRI: Towards discriminative zero-shot remote sensing instance segmentation.** [[paper]](https://arXiv.org/abs/2412.12798) [[code]](https://github.com/HuangShiqi128/ZoRI)
16. [2024 NIPS] **Segment Any Change.** [[paper]](https://proceedings.NIPS.cc/paper_files/paper/2024/file/9415416201aa201902d1743c7e65787b-Paper-Conference.pdf) [[code]](https://github.com/Z-Zheng/pytorch-change-models)
17. [2025 CVPR] **SegEarth-OV: Towards Training-Free Open-Vocabulary Segmentation for Remote Sensing Images.** [[paper]](https://arXiv.org/abs/2410.01768) [[code]](https://github.com/likyoo/SegEarth-OV)
18. [2025 CVPR] **XLRS-Bench: Could Your Multimodal LLMs Understand Extremely Large Ultra-High-Resolution Remote Sensing Imagery?** [[paper]](https://arXiv.org/abs/2503.23771) [[code]](https://github.com/EvolvingLMMs-Lab/XLRS-Bench)
19. [2025 CVPR] **Exact: Exploring Space-Time Perceptive Clues for Weakly Supervised Satellite Image Time Series Semantic Segmentation.** [[paper]](https://openaccess.thecvf.com/content/CVPR2025/papers/Zhu_Exact_Exploring_Space-Time_Perceptive_Clues_for_Weakly_Supervised_Satellite_Image_CVPR_2025_paper.pdf) [[code]](https://github.com/MiSsU-HH/Exact)
...
21. [2025 AAAI] **Towards Open-Vocabulary Remote Sensing Image Semantic Segmentation** [[paper]](https://arxiv.org/abs/2412.19492) [[code]](https://github.com/yecy749/GSNet)
22. [2025 Arxiv] **InstructSAM: A Training-Free Framework for Instruction-Oriented Remote Sensing Object Recognition** [[paper]](https://arxiv.org/pdf/2505.15818) [[code]](https://github.com/VoyagerXvoyagerx/InstructSAM)
23. [2025 Arxiv] **DescribeEarth: Describe Anything for Remote Sensing Images** [[paper]](https://arxiv.org/pdf/2509.25654v1) [[code]](https://github.com/earth-insights/DescribeEarth)
24. [2025 NIPS] **GTPBD: A Fine-Grained Global Terraced Parcel and Boundary Dataset** [[paper]](https://arxiv.org/abs/2507.14697) [[code]](https://github.com/Z-ZW-WXQ/GTPBD)
25. [2025 Arxiv] **RS3DBench: A Comprehensive Benchmark for 3D Spatial Perception in Remote Sensing** [[paper]](https://arxiv.org/abs/2509.18897) [[code]](https://rs3dbench.github.io)
26. [2025 Arxiv] **DGL-RSIS: Decoupling Global Spatial Context and Local Class Semantics for Training-Free Remote Sensing Image Segmentation** [[paper]](https://arxiv.org/pdf/2509.00598) [[code]](https://github.com/designer1024/DGL-RSIS)
27. [2025 TGRS] **A Unified SAM-Guided Self-Prompt Learning Framework for Infrared Small Target Detection** [[paper]](https://ieeexplore.ieee.org/document/11172325) [[code]](https://github.com/fuyimin96/SAM-SPL)
28. [2025 TGRS] **Semantic Prototyping With CLIP for Few-Shot Object Detection in Remote Sensing Images** [[paper]](https://ieeexplore.ieee.org/document/10930588)
29. [2025 Arxiv] **ATRNet-STAR: A Large Dataset and Benchmark Towards Remote Sensing Object Recognition in the Wild** [[paper]](https://arxiv.org/abs/2501.13354) [[code]](https://github.com/waterdisappear/ATRNet-STAR)
30. [2025 Arxiv] **RSKT-Seg: Exploring Efficient Open-Vocabulary Segmentation in the Remote Sensing** [[paper]](https://arxiv.org/pdf/2509.12040) [[code]](https://github.com/LiBingyu01/RSKT-Seg)
31. [2025 ISPRS]  **AdaptVFMs-RSCD: Advancing Remote Sensing Change Detection from binary to semantic with SAM and CLIP** [[paper]](https://doi.org/10.1016/j.isprsjprs.2025.09.010) [[data]](https://github.com/Jiang-CHD-YunNan/RS-VFMs-Fine-tuning-Dataset)
32. [2025 Arxiv]**PeftCD: Leveraging Vision Foundation Models with Parameter-Efficient Fine-Tuning for Remote Sensing Change Detection** [[paper]](https://arxiv.org/pdf/2509.09572) [[code]](https://github.com/dyzy41/PeftCD)
33. [2025 Arxiv] **AlignCLIP: Self-Guided Alignment for Remote Sensing Open-Vocabulary Semantic Segmentation** [[paper]](https://openreview.net/forum?id=hpD3tn7Xbp) [[code]](https://openreview.net/attachment?id=hpD3tn7Xbp&name=supplementary_material)
34. [2025 Arxiv] **Few-Shot Adaptation Benchmark for Remote Sensing Vision-Language Models** [[paper]](https://arxiv.org/pdf/2510.07135) [[code]](https://github.com/elkhouryk/fewshot_RSVLMs)
35. [2025 RSE] **Strategic sampling for training a semantic segmentation model in operational mapping: Case studies on cropland parcel extraction** [[paper]](https://doi.org/10.1016/j.rse.2025.115034) [[data]](https://doi.org/10.5281/zenodo.16595511) [[code]](https://github.com/Remote-Sensing-of-Land-Resource-Lab/Training-Sample-Selection)
36. [2025 TIP] **Universal Fine-Grained Visual Categorization by Concept Guided Learning** [[paper]](https://ieeexplore.ieee.org/document/10829548) [[data]](https://drive.google.com/file/d/11hYbdO32hyspucDKp5wwjwvCaD38AEKe/view?usp=sharing) [[code]](https://github.com/BiQiWHU/CGL)
37. [2025 TIP] **SARATR-X: Towards Building A Foundation Model for SAR Target Recognition** [[paper]](https://ieeexplore.ieee.org/document/10856784) [[code]](https://github.com/waterdisappear/SARATR-X)
38. [2025 TIP] **HSLabeling: Towards Efficient Labeling for Large-scale Remote Sensing Image Segmentation with Hybrid Sparse Labeling** [[paper]](https://ieeexplore.ieee.org/document/10829548) [[data]](https://drive.google.com/drive/folders/1CiYzJyBn1rV-xsrsYQ6o2HDQjdfnadHl) [[code]](https://github.com/linjiaxing99/HSLabeling)
39. [2025 CVM] **Remote sensing tuning: A survey** [[paper]](https://ieeexplore.ieee.org/document/11119145) [[code]](https://github.com/DongshuoYin/Remote-Sensing-Tuning-A-Survey/tree/main)
40. [2025 ISPRS]**Domain generalization for semantic segmentation of remote sensing images via vision foundation model fine-tuning**[[paper]](https://www.sciencedirect.com/science/article/pii/S0924271625003569)[[code]](https://github.com/mmmll23/GeoSA-BaSA)
41. [2025 ISPRS]**Meta Feature Disentanglement under continuous-valued domain modeling for generalizable remote sensing image segmentation on unseen domains**[[paper]](https://www.sciencedirect.com/science/article/pii/S0924271625003879)[[code]](https://github.com/LCB1970/MetaFD)
...
## RS-vHeat
核心速览
本文提出了一种基于热传导理论的高效多模态遥感基础模型RS-vHeat，通过模拟热扩散过程解决传统遥感基础模型计算效率低和可解释性差的问题，在10个数据集上验证了其优越性能。
研究背景

• 研究问题：
    a. 传统遥感任务专用模型难以处理多载荷、多分辨率、多时相、多特征的遥感数据，限制了模型的扩展性和通用性。
    b. 现有遥感基础模型(RSFMs)面临两大挑战：一是计算效率与感受野难以平衡，CNN模型缺乏全局感受野，而基于注意力的模型计算复杂度呈二次方增长；二是物理可解释性弱，难以解释特征传播过程，不利于研究人员调整学习策略。
• 研究难点：
    c. 计算效率与全局建模的矛盾：大尺度遥感图像处理需要大感受野，但现有方法要么计算效率低(注意力机制)，要么感受野受限(CNN)。
    d. 物理可解释性实现：如何将热传导等物理原理融入深度学习模型，使其能够解释遥感对象特征的传播过程。
    e. 多模态数据融合：如何将光学(OPT)和合成孔径雷达(SAR)等不同模态数据映射到统一的热空间进行特征学习。
    
• 文献综述：
    f. CNN-based方法：常用ResNet18/50提取特征，但受限于固定尺寸卷积核，难以捕获长程依赖关系。
    g. Transformer-based方法：使用ViT或Swin Transformer等注意力机制捕获全局依赖，但计算复杂度高。
    h. Mamba-based方法：利用状态空间模型(SSMs)的选择性扫描机制处理长序列，平衡计算效率与精度。
    i. 现有RSFMs多采用掩码重建、知识蒸馏或对比学习等自监督策略增强模型鲁棒性，但缺乏物理基础的理论解释。
研究方法

• 热传导算子（HCO）：RS-vHeat采用热传导算子模拟高分辨率遥感图像中的局部区域相关性，其复杂度为O(N^1.5)，具有全局感受野。HCO通过热传导微分方程建模像素间的语义关系，将输入特征映射到热空间，利用二维离散余弦变换（DCT）和逆变换（IDCT）实现热扩散计算。具体公式为：U_t^m = IDCT2D(DCT2D(U_0^m) e^{-k(ω_x^2+ω_y^2)t})，其中k为热扩散系数，由频率值嵌入（FVEs）动态预测。

• 频率域分层掩码策略：为解决传统空间掩码导致小目标丢失的问题，提出基于频率域的分层掩码。输入图像通过DCT转换为频域后，随机掩码20%-30%的高频或低频成分，再通过IDCT还原为空间域图像。该策略通过保留频域信号完整性，提升模型对小目标的敏感性。

• 空间校正嵌入（SCEs）：设计轻量级校正学习器，通过预训练生成SCEs（权重W_SCEs ∈ R^{M×N×C}）动态调整热扩散边界。SCEs与温度场特征Z_p^m交互，实现空间域的自适应校正，公式为：Z'_p^m = CL(Z_p^m, W_SCEs)。该模块直接作用于全局特征，增强局部细节建模能力。

实验设计

• 预训练数据集：使用包含45万组匹配的光学-SAR图像对的多模态数据集（总计300万张图像），图像尺寸为224×224，遵循RingMo的数据处理方法。训练在8块A100（80G）GPU上进行，共200轮，初始学习率1e-6，经10轮预热后升至2e-4，采用余弦退火调度。

• 下游任务评估：在4类任务（语义分割、目标检测、分类、变化检测）和10个数据集上测试。语义分割采用UPerNet头，目标检测使用YOLOX头，变化检测基于BIT架构。对比模型包括CNN-based（ResNet）、ViT-based（ViT/Swin）和Swin-based的14种RSFM。

• 效率指标：测试不同图像尺寸下的吞吐量、GPU内存和FLOPs。RS-vHeat处理1024×1024图像时，吞吐量达2.7倍于Swin-B模型（如SatLas），内存降低84%，FLOPs减少24%；相比ViT-B的SpectralGPT，吞吐量提升2.5倍，内存降低77%。

结果与分析

• 语义分割性能：在iSAID和Potsdam数据集上，RS-vHeat的mIoU达68.72%，超越Scale-MAE 2.95%，FLOPs仅为921G（ViT-L为1536G）。在SAR专用数据集AIR-PolSAR-Seg上，mIoU达57.46%，优于DANet（51.93%）和GCNet（47.56%）。

• 目标检测效率：DIOR数据集上mAP50为82.3%，高于SkySense（78.73%），FLOPs仅266G（Swin-H为1679G）。SAR-AIRcraft-1.0数据集的mAP50达87.1%，显著超过SA-Net（77.7%）。

• 计算效率优势：如图4所示，RS-vHeat在1024×1024图像处理中，内存占用从Swin-B的15.2GB降至2.4GB，FLOPs从968G降至921G，吞吐量从42 img/s提升至113 img/s。

• 消融实验验证：对比仅空间域重建（SDR）、加入频域重建（FDR）和引入对比损失（CL）的配置，CL使WHU-OPT-SAR的OA提升至83.9%（+1.6%）。SCEs模块使DIOR的mAP50从78.2%提升至82.3%。

总体结论

• 关键创新：首次将热传导理论引入遥感基础模型，提出具有物理可解释性的RS-vHeat，通过热扩散模拟遥感对象结构特征，实现多模态数据在热空间的统一表征。

• 性能突破：在10个数据集上全面超越现有RSFM，最高提升mAP50 3.57%（DIOR），mIoU 2.95%（iSAID），同时计算效率显著优化，大尺度图像处理内存降低84%。

• 方法论意义：频率域分层掩码与多域重建策略解决了小目标丢失问题，热传导算子（HCO）为长程依赖建模提供了O(N^1.5)复杂度的新范式，为遥感视觉模型的高效设计开辟了新路径。
