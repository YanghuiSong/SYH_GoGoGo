...
4. [⭐ 2025 Meta] **SAM 3: Segment Anything with Concepts** [[paper]](https://openreview.net/pdf?id=r35clVtGzw)[[code]](https://github.com/facebookresearch/sam3)[[SAM 3模型的改进思路]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3.md)[[SAM3的复现效果]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/ExSAM3.md)
