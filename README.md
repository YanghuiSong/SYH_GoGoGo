...
4. [2025 arXiv] **SAM3-Adapter: Efficient Adaptation of Segment Anything 3 for Camouflage Object Segmentation** [[paper]](https://arxiv.org/pdf/2511.19425)[[code]](https://github.com/tianrun-chen/SAM-Adapter-PyTorch)[[使用适配器解锁SAM3极精细边界的能力]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3_Adapter.md)[[代码详解]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3-AdapterCodeLearn.md)
5. [2025 NIPS] **DICEPTION: A Generalist Diffusion Model for Vision Perception** [[paper]](https://arxiv.org/pdf/2502.17157)[[code]](https://arxiv.org/pdf/2502.17157)[[虽然未使用SAM，但是基于预训练扩散模型的**视觉通才模型**，旨在以**单一模型**解决多种视觉感知任务，并在多个方面对现有方法（尤其是**SAM**）提出了改进]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/DICEPTION.md)
6. [2025 NIPS] **HyperET: Efficient Training in Hyperbolic Space for Multi-modal Large Language Models** [[paper]](https://arxiv.org/pdf/2510.20322)[[未找到代码!]][[HyperET与SAM3的"多粒度本质不谋而合"]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/HyperET.md)
7. [2025 arXiv] **SegEarth-OV3: Exploring SAM 3 for Open-Vocabulary Semantic Segmentation in Remote Sensing Images** [[paper]](https://arxiv.org/pdf/2512.08730)[[code]](https://github.com/earth-insights/SegEarth-OV-3)[[尽可能利用SAM3的输出]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SegEarth3.md)
8. [2025 CVPR] **Segment This Thing: Foveated Tokenization for Efficient Point-Prompted Segmentation** [[paper]](https://arxiv.org/pdf/2506.11131)[[code]](https://github.com/facebookresearch/segment_this_thing?tab=readme-ov-file)[[STT 是一种针对实时单点提示分割的专化设计，通过动态分辨率 tokenization 在保持模型容量的同时大幅降低计算成本，适合 AR、机器人等低延迟场景]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/STT.md)
9. [2025 CVPR] **Segment Any-Quality Images with Generative Latent Space Enhancement** [[paper]](https://arxiv.org/pdf/2503.12507)[[code]](https://github.com/guangqian-guo/GleSAM)[[在Segment Anything Model (SAM)的潜在空间中引入预训练扩散模型的去噪能力，解决低质量图像分割性能下降的问题]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/GleSAM.md)
10. [2025 ICCV] **E-SAM: Training-Free Segment Every Entity Model** [[paper]](https://arxiv.org/pdf/2503.12094)[[code暂时没有]](https://github.com/weimingz996/E-SAM)[[E-SAM 是一个无需训练的框架，基于 SAM 的 AMG 模式进行优化]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/E-SAM.md)
...
18. [2025 arXiv] **ReSAM: Refine, Requery, and Reinforce: Self-Prompting Point-Supervised Segmentation for Remote Sensing Images** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=ReSAM%3A+Refine%2C+Requery%2C+and+Reinforce%3A+Self-Prompting+Point-Supervised+Segmentation+for+Remote+Sensing+Images&btnG=)[[code]](https://github.com/MNaseerSubhani/ReSAM)
19. [2026 arXiv] **Taming SAM3 in the Wild: A Concept Bank for Open-Vocabulary Segmentation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Taming+SAM3+in+the+Wild%3A+A+Concept+Bank+for+Open-Vocabulary+Segmentation&btnG=)[[code]](https://github.com/PGSmall/ConceptBank)[[https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3CB.md]]
20. [2026 TIP] **Boosting Segment Anything Model to Generalize to Visually Non-Salient Scenarios** [[paper]](https://arxiv.org/pdf/2601.00537)[[code]](https://github.com/guangqian-guo/VNS-SAM)
