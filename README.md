...
13. [[Multi-Modal(VLMs)](#Multi_Modal)]
...
11. [2025 arXiv] **MMMamba:AVersatile Cross-Modal In Context Fusion Framework for Pan-Sharpening and Zero-Shot Image Enhancement** [[paper]](https://arxiv.org/pdf/2512.15261)[[code]](https://github.com/Gracewangyy/MMMamba)[[ 将高分辨率全色图像（PAN）与低分辨率多光谱图像（MS）融合，生成高分辨率多光谱图像（HRMS）]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/MMMamba.md)
...
<a name="KD"></a>  
## KD
1. [2026 CVPR] **Generalizable Knowledge Distillation from Vision Foundation Models for Semantic Segmentation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Generalizable+Knowledge+Distillation+from+Vision+Foundation+Models+for+Semantic+Segmentation&btnG=)[[code]](https://github.com/Younger-hua/GKD) [[如何在压缩模型的同时，保留甚至增强其跨域泛化能力？]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/GKD.md)
<a name="TerraFM"></a>  
## 统一多传感器的遥感可扩展基础模型
...
2. [2023 arXiv] **Fast segment anything** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=fast+segment+anything&btnG=&oq=%09+Fast+segment+anything) [[code]](https://github.com/CASIA-LMC-Lab/FastSAM) [[使用CNN替代Transformer：利用CNN的计算效率，构建更轻量的分割模型
]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/FastSAM.md)
...
4. [⭐ 2025 Meta] **SAM 3: Segment Anything with Concepts** [[paper]](https://openreview.net/pdf?id=r35clVtGzw)[[code]](https://github.com/facebookresearch/sam3)[[SAM 3模型的改进思路]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3.md)[[SAM3的复现效果]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/ExSAM3.md)[[patch间固有问题对于存在性token可能的影响]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/IssueSAM1.md)[[实例编码器与图像编码器之间可能存在的gap]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/IssueSAM2.md)[[SAM3各层解析]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3Layers.md)[[一张图片和提示从输入到输出的完整变化过程]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3IOLearning.md)
5. [2025 arXiv] **SAM3-Adapter: Efficient Adaptation of Segment Anything 3 for Camouflage Object Segmentation** [[paper]](https://arxiv.org/pdf/2511.19425)[[code]](https://github.com/tianrun-chen/SAM-Adapter-PyTorch)[[使用适配器解锁SAM3极精细边界的能力]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3_Adapter.md)[[代码详解]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3-AdapterCodeLearn.md)
6. [2025 NIPS] **DICEPTION: A Generalist Diffusion Model for Vision Perception** [[paper]](https://arxiv.org/pdf/2502.17157)[[code]](https://arxiv.org/pdf/2502.17157)[[虽然未使用SAM，但是基于预训练扩散模型的**视觉通才模型**，旨在以**单一模型**解决多种视觉感知任务，并在多个方面对现有方法（尤其是**SAM**）提出了改进]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/DICEPTION.md)
7. [2025 NIPS] **HyperET: Efficient Training in Hyperbolic Space for Multi-modal Large Language Models** [[paper]](https://arxiv.org/pdf/2510.20322)[[未找到代码!]][[HyperET与SAM3的"多粒度本质不谋而合"]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/HyperET.md)
8. [2025 arXiv] **SegEarth-OV3: Exploring SAM 3 for Open-Vocabulary Semantic Segmentation in Remote Sensing Images** [[paper]](https://arxiv.org/pdf/2512.08730)[[code]](https://github.com/earth-insights/SegEarth-OV-3)[[尽可能利用SAM3的输出]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SegEarth3.md)
9. [2025 CVPR] **Segment This Thing: Foveated Tokenization for Efficient Point-Prompted Segmentation** [[paper]](https://arxiv.org/pdf/2506.11131)[[code]](https://github.com/facebookresearch/segment_this_thing?tab=readme-ov-file)[[STT 是一种针对实时单点提示分割的专化设计，通过动态分辨率 tokenization 在保持模型容量的同时大幅降低计算成本，适合 AR、机器人等低延迟场景]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/STT.md)
10. [2025 CVPR] **Segment Any-Quality Images with Generative Latent Space Enhancement** [[paper]](https://arxiv.org/pdf/2503.12507)[[code]](https://github.com/guangqian-guo/GleSAM)[[在Segment Anything Model (SAM)的潜在空间中引入预训练扩散模型的去噪能力，解决低质量图像分割性能下降的问题]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/GleSAM.md)
11. [2025 ICCV] **E-SAM: Training-Free Segment Every Entity Model** [[paper]](https://arxiv.org/pdf/2503.12094)[[code暂时没有]](https://github.com/weimingz996/E-SAM)[[E-SAM 是一个无需训练的框架，基于 SAM 的 AMG 模式进行优化]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/E-SAM.md)
12. [2025 TGRS] **SAM-Assisted Remote Sensing Imagery Semantic Segmentation With Object and Boundary Constraints**[[paper]](https://ieeexplore.ieee.org/document/10636322)[[code]](https://github.com/sstary/SSRS)[[利用Segment Anything Model (SAM) 的原始输出来增强遥感图像语义分割性能的简单而有效的框架]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM-Assisted.md)
13. [2025 arXiv] **Evolving, Not Training: Zero-Shot Reasoning Segmentation via Evolutionary Prompting** [[paper]](https://arxiv.org/pdf/2512.24702)[[code]](https://github.com/AHideoKuzeA/Evol-SAM3)[[将MLLM的推理能力用于导航复杂的语义空间，同时保留SAM 3的稳健几何先验，避免了微调的灾难性遗忘风险]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/EVOL-SAM3.md)
14. [2025 arXiv] **SAM3-I: Segment Anything with Instructions** [[paper]](https://arxiv.org/pdf/2512.04585)[[code]](https://github.com/debby-0527/SAM3-I) [[一种"指令感知级联适配器"，用于直接处理复杂自然语言指令，无需外部多模态模型]]（https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3-I.md)
15. [2026 arXiv] **OmniOVCD: Streamlining Open-Vocabulary Change Detection with SAM 3** [[paper]](https://arxiv.org/pdf/2601.13895v1)[[一种名为OmniOVCD的单一框架，用于开放词汇变化检测（Open-Vocabulary Change Detection, OVCD）]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/OmniOVCD.md)
16. [2025 arXiv] **TextRegion: Text-Aligned Region Tokens from Frozen Image-Text Models** [[paper]](https://arxiv.org/pdf/2505.23769)[[code]](https://github.com/avaxiao/TextRegion)[[提出了一种简单、有效且无需训练的框架，将图像-文本模型与SAM2结合，生成文本对齐的区域标记]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/TextRegion.md)[[文本对齐区域令牌生成框架]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/TextRegionCode.md)
17. [2025 arXiv] **TopoLoRA-SAM: Topology-Aware Parameter-Efficient Adaptation of Foundation Segmenters for Thin-Structure and Cross-Domain Binary Semantic Segmentation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=TopoLoRA-SAM%3A+Topology-Aware+Parameter-Efficient+Adaptation+of+Foundation+Segmenters+for+Thin-Structure+and+Cross-Domain+Binary+Semantic+Segmentation&btnG=)[[code]](https://github.com/salimkhazem/Seglab)[[拓扑感知的参数高效适应方法用于细结构和跨域二元语义分割]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/TopoLoRA-SAM.md)
18. [2025 ACM MM] **Remotesam: Towards segment anything for earth observation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=RemoteSAM%3A+Towards+Segment+Anything+for+Earth+Observation&btnG=) [[code]](https://github.com/1e12Leon/RemoteSAM)
19. [2025 arXiv] **ReSAM: Refine, Requery, and Reinforce: Self-Prompting Point-Supervised Segmentation for Remote Sensing Images** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=ReSAM%3A+Refine%2C+Requery%2C+and+Reinforce%3A+Self-Prompting+Point-Supervised+Segmentation+for+Remote+Sensing+Images&btnG=)[[code]](https://github.com/MNaseerSubhani/ReSAM)
20. [2026 arXiv] **Taming SAM3 in the Wild: A Concept Bank for Open-Vocabulary Segmentation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Taming+SAM3+in+the+Wild%3A+A+Concept+Bank+for+Open-Vocabulary+Segmentation&btnG=)[[code]](https://github.com/PGSmall/ConceptBank)[[https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SAM3CB.md]]
21. [2026 TIP] **Boosting Segment Anything Model to Generalize to Visually Non-Salient Scenarios** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Boosting+Segment+Anything+Model+to+Generalize+to+Visually+Non-Salient+Scenarios&btnG=)[[code]](https://github.com/guangqian-guo/VNS-SAM)
...
9. [2025 ICCV] **FreeCP: Training-Free Class Purification for Open-Vocabulary Semantic Segmentation** [[paper]](https://openaccess.thecvf.com/content/ICCV2025/papers/Chen_Training-Free_Class_Purification_for_Open-Vocabulary_Semantic_Segmentation_ICCV_2025_paper.pdf)[[code]](https://github.com/chenqi1126/FreeCP)[[FreeCP（Free Class Purification），一种无需训练的类别净化框架，用于提升开放词汇语义分割的性能。hu_SkySense-O_Towards_Open-World_Remote_Sensing_Interpretation_with_Vision-Centric_Visual-Language_Modeling_CVPR_2025_paper.pdf)[[code]](https://github.com/zqcrafts/SkySense-O)
10. [2025 ICCV] **Plug-in Feedback Self-adaptive Attention in CLIP for Training-free Open-Vocabulary Segmentation** [[paper]](https://arxiv.org/pdf/2508.20265)[[code]](https://github.com/chi-chi-zx/FSA)[[一种即插即用的注意力反馈机制]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/FSA.md)
11. [2025 ICCV] **Feature Purification Matters: Suppressing Outlier Propagation for Training-Free Open-Vocabulary Semantic Segmentation** [[paper]](https://openaccess.thecvf.com/content/ICCV2025/papers/Jin_Feature_Purification_Matters_Suppressing_Outlier_Propagation_for_Training-Free_Open-Vocabulary_Semantic_ICCV_2025_paper.pdf)[[code]](https://github.com/Kimsure/SFP)[[特征净化（Feature Purification）的方法，旨在通过剔除CLIP视觉注意力图中的异常值，提升分割的针对性和准确性]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SFP.md)
12. [2025 ICCV] **OmniSAM: Omnidirectional Segment Anything Model for UDA in Panoramic Semantic Segmentation** [[paper]](https://openaccess.thecvf.com/content/ICCV2025/papers/Zhong_OmniSAM_Omnidirectional_Segment_Anything_Model_for_UDA_in_Panoramic_Semantic_ICCV_2025_paper.pdf)[[code]](https://github.com/Ding-Zhong/OmniSAM)
13. [2025 TIP] **Self-Calibrated CLIP for Training-Free Open-Vocabulary Segmentation** [[paper]](https://arxiv.org/pdf/2411.15869)[[code]](https://github.com/SuleBai/SC-CLIP)[[一种自校准处理异常token的方法]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SelfCLIP.md)[[SC-CLIP的代码详解以及迁移到SAM3可能的方法]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SC-CLIPCode.md)
14. [2025 WACV] **Pay Attention to Your Neighbours: Training-Free Open-Vocabulary Semantic Segmentation** [[paper]](https://openaccess.thecvf.com/content/WACV2025/papers/Hajimiri_Pay_Attention_to_Your_Neighbours_Training-Free_Open-Vocabulary_Semantic_Segmentation_WACV_2025_paper.pdf)[[code]](https://github.com/sinahmr/NACLIP)[[像素领域感知的一种方法并于SAM3产生联想]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/NACLIP.md)
15. [2026 TGRS] **A Fuzzy-Embedded Edge Enhancement Network via Segment Anything Model for VHR Remote Sensing Images Change Detection** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=A+Fuzzy-Embedded+Edge+Enhancement+Network+via+Segment+Anything+Model+for+VHR+Remote+Sensing+Images+Change+Detection&btnG=)[[模糊嵌入边缘增强网络用于VHR遥感图像变化检测]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/MFEFM.md)


<a name="TTA"></a>  
## Test-Time Adaptation
1. [2026 CVPR] **FOZO: Forward-Only Zeroth-Order Prompt Optimization for Test-Time Adaptation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=FOZO%3A+Forward-Only+Zeroth-Order+Prompt+Optimization+for+Test-Time+Adaptation&btnG=)[[code]](https://github.com/eVI-group-SCU/FOZO?tab=readme-ov-file) [[测试时自适应的零阶提示优化 ]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/FOZO.md)
...
2. [✨2025 CVPR] **SegEarth-OV: Towards Training-Free Open-Vocabulary Segmentation for Remote Sensing Images** [[paper]](https://openaccess.thecvf.com/content/CVPR2025/papers/Li_SegEarth-OV_Towards_Training-Free_Open-Vocabulary_Segmentation_for_Remote_Sensing_Images_CVPR_2025_paper.pdf) [[code]](https://github.com/likyoo/SegEarth-OV)[[Notes]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SegEarth.md)[[SegEarthOV从输入到输出的变化]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SegEarthCode.md)
...
41. [2025 TGRS] **ST-Mamba: Spatio-Temporal Synergistic Model for Remote Sensing Change Detection** [[paper]](https://ieeexplore.ieee.org/abstract/document/11036543)[[code]]()[[解决遥感影像伪变化]]()
42. [2025 TGRS] **CLIP2RS: Leveraging Pretrained Vision-Language Model for Semantic Segmentation of Remote Sensing Images** [[paper]](https://scholar.google.com.hk/scholar?hl=zh-CN&as_sdt=0%2C5&q=CLIP2RS%3A+Leveraging+Pretrained+Vision-Language+Model+for+Semantic+Segmentation+of+Remote+Sensing+Images&btnG=)[[CLIP2RS采用两阶段训练策略来克服自然图像和遥感图像之间的域差距]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/CLIP2RS.md)
43. [2025 Arxiv] **ATRNet-STAR: A Large Dataset and Benchmark Towards Remote Sensing Object Recognition in the Wild** [[paper]](https://arxiv.org/abs/2501.13354) [[code]](https://github.com/waterdisappear/ATRNet-STAR)
44. [2025 Arxiv] **RSKT-Seg: Exploring Efficient Open-Vocabulary Segmentation in the Remote Sensing** [[paper]](https://arxiv.org/pdf/2509.12040) [[code]](https://github.com/LiBingyu01/RSKT-Seg)
45. [2025 ISPRS]  **AdaptVFMs-RSCD: Advancing Remote Sensing Change Detection from binary to semantic with SAM and CLIP** [[paper]](https://doi.org/10.1016/j.isprsjprs.2025.09.010) [[data]](https://github.com/Jiang-CHD-YunNan/RS-VFMs-Fine-tuning-Dataset)
46. [2025 Arxiv]**PeftCD: Leveraging Vision Foundation Models with Parameter-Efficient Fine-Tuning for Remote Sensing Change Detection** [[paper]](https://arxiv.org/pdf/2509.09572) [[code]](https://github.com/dyzy41/PeftCD)
47. [2025 Arxiv] **AlignCLIP: Self-Guided Alignment for Remote Sensing Open-Vocabulary Semantic Segmentation** [[paper]](https://openreview.net/forum?id=hpD3tn7Xbp) [[code]](https://openreview.net/attachment?id=hpD3tn7Xbp&name=supplementary_material)
48. [2025 Arxiv] **Few-Shot Adaptation Benchmark for Remote Sensing Vision-Language Models** [[paper]](https://arxiv.org/pdf/2510.07135) [[code]](https://github.com/elkhouryk/fewshot_RSVLMs)
49. [2025 RSE] **Strategic sampling for training a semantic segmentation model in operational mapping: Case studies on cropland parcel extraction** [[paper]](https://doi.org/10.1016/j.rse.2025.115034) [[data]](https://doi.org/10.5281/zenodo.16595511) [[code]](https://github.com/Remote-Sensing-of-Land-Resource-Lab/Training-Sample-Selection)
50. [2025 TIP] **Universal Fine-Grained Visual Categorization by Concept Guided Learning** [[paper]](https://ieeexplore.ieee.org/document/10829548) [[data]](https://drive.google.com/file/d/11hYbdO32hyspucDKp5wwjwvCaD38AEKe/view?usp=sharing) [[code]](https://github.com/BiQiWHU/CGL)
51. [2025 TIP] **SARATR-X: Towards Building A Foundation Model for SAR Target Recognition** [[paper]](https://ieeexplore.ieee.org/document/10856784) [[code]](https://github.com/waterdisappear/SARATR-X)
52. [2025 TIP] **HSLabeling: Towards Efficient Labeling for Large-scale Remote Sensing Image Segmentation with Hybrid Sparse Labeling** [[paper]](https://ieeexplore.ieee.org/document/10829548) [[data]](https://drive.google.com/drive/folders/1CiYzJyBn1rV-xsrsYQ6o2HDQjdfnadHl) [[code]](https://github.com/linjiaxing99/HSLabeling)
53. [2025 CVM] **Remote sensing tuning: A survey** [[paper]](https://ieeexplore.ieee.org/document/11119145) [[code]](https://github.com/DongshuoYin/Remote-Sensing-Tuning-A-Survey/tree/main)
54. [2025 ISPRS]**Domain generalization for semantic segmentation of remote sensing images via vision foundation model fine-tuning**[[paper]](https://www.sciencedirect.com/science/article/pii/S0924271625003569)[[code]](https://github.com/mmmll23/GeoSA-BaSA)
55. [2025 ISPRS]**Meta Feature Disentanglement under continuous-valued domain modeling for generalizable remote sensing image segmentation on unseen domains**[[paper]](https://www.sciencedirect.com/science/article/pii/S0924271625003879)[[code]](https://github.com/LCB1970/MetaFD)
56. [2026 AAAI] **LWGANet: Addressing Spatial and Channel Redundancy in Remote Sensing Visual Tasks with Light-Weight Grouped Attention** [[paper]](https://arxiv.org/pdf/2501.10040)[[code]](https://github.com/AeroVILab-AHU/LWGANet)[[轻量化去除空间冗余和通道冗余]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/LWGA.md)
57. [2026 AAAI] **MaRS: A Multi-Modality Very-High-Resolution Remote Sensing Foundation Model with Cross-Granularity Meta-Modality Learning** [[paper]](https://rsidea.whu.edu.cn/mars.pdf) [[code]](https://github.com/WanderRainy/MaRS)[[融合patch级、image级和patch-to-global三粒度超高分辨率SAR-光学多模态遥感基础模型]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/MARS.md)
58. [2026 ICLR] **GeoAlignCLIP: Enhancing Fine-Grained Vision-Language Alignment in Remote Sensing via Multi-Granular Consistency Learning** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=GeoAlignCLIP%3A+Enhancing+Fine-Grained+Vision-Language+Alignment+in+Remote+Sensing+via+Multi-Granular+Consistency+Learning&btnG=)[[多粒度对比学习，多尺度一致性学习]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/GeoAlignCLIP.md)
...
17. [2026 CVPR] **Dr. Seg: Revisiting GRPO Training for Visual Large Language Models through Perception-Oriented Design** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Dr.+Seg%3A+Revisiting+GRPO+Training+for+Visual+Large+Language+Models+through+Perception-Oriented+Design&btnG=)[[code]](https://github.com/eVI-group-SCU/Dr-Seg)[[将语言推理任务的GRPO训练范式直接迁移到视觉感知任务存在本质错配]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/DrSeg.md)
...
11. [2025 arXiv] **No time to train! Training-Free Reference-Based Instance Segmentation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=No+time+to+train%21+Training-Free+Reference-Based+Instance+Segmentation&btnG=) [[code]](https://github.com/miquel-espinosa/no-time-to-train) [[Dino2+Sam2实现免训练的实例分割]](https://github.com/YanghuiSong/SYH_GoGoGo/tree/main/Notes)
12. [2025 ICCV] **Stronger, Steadier & Superior: Geometric Consistency in Depth VFM Forges Domain Generalized Semantic Segmentation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=+Stronger%2C+Steadier+%26+Superior%3A+Geometric+Consistency+in+Depth+VFM+Forges+Domain+Generalized+Semantic+Segmentation&btnG=) [[code]](https://github.com/SY-Ch/DepthForge) [[通过几何一致性实现域泛化语义分割的深度感知方法]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SS-DGSS.md)
13. [2026 CVPR] **CrossEarth-Gate: Fisher-Guided Adaptive Tuning Engine for Efficient Adaptation of Cross-Domain Remote Sensing Semantic Segmentation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=CrossEarth-Gate%3A+Fisher-Guided+Adaptive+Tuning+Engine+for+Efficient+Adaptation+of+Cross-Domain+Remote+Sensing+Semantic+Segmentation&btnG=) [[code]](https://github.com/VisionXLab/CrossEarth-SAR) [[利用Fisher信息动态选择最相关的遥感模块，实现高效的跨域遥感语义分割适应]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/CrossEarthGate.md)
14. [2026 TGRS] **CAMformer: A Single-Stage CNN-Transformer Hybrid for Weakly Supervised Semantic Segmentation in Aerial Imagery** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=CAMformer%3A+A+Single-Stage+CNN-Transformer+Hybrid+for+Weakly+Supervised+Semantic+Segmentation+in+Aerial+Imagery&btnG=) [[遥感图像弱监督语义分割(WSSS)]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/CAMformer.md)
15. [2025 ICCV] **Harnessing Vision Foundation Models for High-Performance, Training-Free Open Vocabulary Segmentation** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Harnessing+Vision+Foundation+Models+for+High-Performance%2C+Training-Free+Open+Vocabulary+Segmentation&btnG=)[[code]](https://github.com/YuHengsss/Trident) [[利用视觉基础模型实现免训练开放词汇分割]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/Trident.md)
16. [2026 CVPR] **INSID3: Training-Free In-Context Segmentation with DINOv3** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=INSID3%3A+Training-Free+In-Context+Segmentation+with+DINOv3&btnG=)[[code]](https://github.com/visinf/INSID3)[[仅通过 DINOv3 的密集自监督特征（Frozen Features），无需任何解码器、微调或模型组合，即可直接涌现出强大的分割能力]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/INSID3.md)
...
4. [2026 CVPR] **WeDetect: Fast Open-Vocabulary Object Detection as Retrieval** [[paper]](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=WeDetect%3A+Fast+Open-Vocabulary+Object+Detection+as+Retrieval&btnG=)[[code]](https://github.com/WeChatCV/WeDetect?tab=readme-ov-file)[[将识别任务视为检索任务]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/WeDetect.md)
