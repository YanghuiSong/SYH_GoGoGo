...
9. [2024 arXiv] **Self-Calibrated CLIP for Training-Free Open-Vocabulary Segmentation** [[paper]](https://arxiv.org/pdf/2411.15869)[[code]](https://github.com/SuleBai/SC-CLIP)[[Notes]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SelfCLIP.md)[[不更新任何模型参数的前提下，通过精心设计的前向计算流程，实现了CLIP模型的性能提升]](https://github.com/YanghuiSong/SYH_GoGoGo/blob/main/Notes/SC-CLIPCode.md)
